...
const QUIZ_QUESTIONS = [
  {
    ...
    answers: [
      { text: "The one who does the research nobody asked for", key: "A" },
      { text: "The one who builds the actual thing", key: "B" },
      { text: "The one who presents it", key: "C" },
      { text: "The one who sets the deadlines and makes sure people meet them", key: "D" },
    ],
  },
  {
    number: 2,
    ...
    answers: [
      { text: "The one with the craziest stories", key: "A" },
      { text: "The one who always warns them and is always right", key: "B" },
      { text: "The one who fixes everything", key: "C" },
      { text: "Hard to read but always watching", key: "D" },
    ],
  },
  {
    number: 3,
    ...
    answers: [
      { text: "In the middle of the room holding court", key: "A" },
      { text: "You organized the party", key: "B" },
      { text: "Showed up uninvited and somehow became the main character", key: "C" },
      { text: "By the door, watching who comes in and who leaves", key: "D" },
    ],
  },
  {
    number: 4,
    ...
    answers: [
      { text: "You already knew. You've been watching them for weeks", key: "A" },
      { text: "You check the comms. The evidence is in the data", key: "B" },
      { text: "You take them out to drinks and get them talking", key: "C" },
      { text: "You noticed their behaviour changed three days ago", key: "D" },
    ],
  },
  {
    number: 5,
    ...
    answers: [
      { text: "Disappear. Regroup. Come back with a new angle", key: "A" },
      { text: "Switch to Plan B. You always had a Plan B", key: "B" },
      { text: "Improvise. The best moves aren't planned", key: "C" },
      { text: "You saw it coming. You already told them this would happen", key: "D" },
    ],
  },
  {
    number: 6,
    ...
    answers: [
      { text: "Say absolutely nothing. Let them try to prove you were ever there", key: "A" },
      { text: "Study the room's security and find a structural loop to exploit", key: "B" },
      { text: "Flash a confident smile and charm your way out of the cuffs", key: "C" },
      { text: "Give them a completely chaotic story that sends their agents in the wrong direction", key: "D" },
    ],
  },
  {
    number: 7,
    ...
    answers: [
      { text: "You're the reason the door is open", key: "A" },
      { text: "You're counting down the seconds and making sure everyone gets out", key: "B" },
      { text: "You weren't supposed to be here but you're grabbing what you can", key: "C" },
      { text: "You're watching the corridor. If anyone's coming, the crew knows first", key: "D" },
    ],
  },
];

const ROLE_DATA = {
  ghost: { title: "THE GHOST", color: COLORS.charcoal, accent: "#555", desc: "The infiltrator. You were never here. No trace, no trail. Quiet, strategic, observant. The crew doesn't always see you — but they always need you." },
  specialist: { title: "THE SPECIALIST", color: "#8A8A8A", accent: "#B0B0B0", desc: "The builder. You're the reason the door opened in the first place. Problem solver. Resourceful under pressure. When the plan breaks, you fix it." },
  charmer: { title: "THE CHARMER", color: COLORS.gold, accent: "#D4B85C", desc: "The front of the operation. You talk your way into rooms, hold attention, and keep security distracted while the crew moves. People remember you." },
  driver: { title: "THE DRIVER", color: COLORS.offWhite, accent: "#E0D8C8", desc: "You keep the operation moving. Timing. Logistics. Making sure everyone is where they need to be. Without you, the heist stalls." },
  wildcard: { title: "THE WILDCARD", color: COLORS.red, accent: "#D94E41", desc: "The unpredictable element. You improvise when the plan goes sideways. The crew doesn't always trust you — but they always need you." },
  lookout: { title: "THE LOOKOUT", color: "#4A7C59", accent: "#6B9E7A", desc: "Eyes everywhere. You see what's coming before anyone else does. The crew moves because you told them the coast is clear. Nothing gets past you." },
};
  ...
  const handleSelect = (answer) => {
    ...
    setTimeout(() => {
      ...
      if (qIdx < QUIZ_QUESTIONS.length - 1) {
        ...
        // Role balancing: randomly assign from the 6 roles
        // In production this would check counts from Supabase
        // For now, purely random from the pool
        const roles = ['ghost', 'specialist', 'charmer', 'driver', 'wildcard', 'lookout'];
...
function FormPage({ page, formData, setFormData, onNext, onBack, role }) {
  ...
  const fields = isIdentity
    ...
    : [
        ...
        { key: "treatment", label: "What countermeasures must be on hand?", placeholder: "The antidote for your condition...", type: "text" },
        { key: "accommodation", label: "Will you share quarters with another operative?", placeholder: "", type: "select", options: ["Mixed","Same Sex"] },
